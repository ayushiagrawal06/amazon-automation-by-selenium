...
public abstract class CommonUtils {
    ...
    public void navigateBack() throws TestException {
        try {
    ...
    public String getPageTitle() throws TestException {
        try {
    ...
    public String getCurrentURL() throws TestException {
        try {
    ...
    public List<String> getListOfElementTexts(By selector) throws TestException {
    ...
    public void click(By selector) throws TestException {
    ...
    public void scrollToThenClick(By selector) throws TestException {
    ...
    public void sendKeys(By selector, String value) throws TestException {
        WebElement element = getElement(selector);
        clearField(element);
        try {
    ...
    public void waitForElementToBeClickable(By selector) throws TestException {
        try {
            wait = new WebDriverWait(_driver, timeout);
    ...
    public void selectIfOptionTextContains(By selector, String searchCriteria) throws TestException {
    ...
    public void selectIfOptionTextEquals(By selector, String searchCriteria) throws TestException {
    ...
    public List<String> getDropdownValues(By selector) throws TestException {

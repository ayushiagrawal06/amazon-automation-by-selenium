package com.selenium.projects.amazon.actions;
...
import com.selenium.projects.amazon.pages.*;
...
public class OrderActions {
    ...
    public void loginAs(String username, String password) throws TestException {
        HomePage homePage = new HomePage();
    ...
    public Book loadProductPageDataIntoProductObject(Products product) throws TestException {
    ...
    public void addProductToShoppingCartReview(Products product) throws TestException {
    ...
    public Book loadShoppingCartDataIntoProductObject(Products product) throws TestException {
    ...
    public void initializeLogin() throws TestException {
        System.out.println("INITIALIZING: Signing out, if needed.\n");
        signOut();
    }

    public void initializeCart() throws TestException {
    ...
    public void deleteAllItemsIfAnyFromCart() throws TestException {
        HomePage homePage = new HomePage();
        ShoppingCartPage shoppingCartPage = new ShoppingCartPage();
